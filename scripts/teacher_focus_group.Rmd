...
Of the 1,008 student from the 2018-19 study, only 430 students had complete ORF data across the four measurement occasions for both measures, CORE and Traditional ORF. For each grade, we randomly sampled four students that scored at or above the 10th percentile and at or below the 25th percentile.
...
* Teachers were provided with the student’s fall easyCBM oral reading fluency score in words correct per minute (WCPM) and were asked to:
  + describe the student’s reading level based on this score alone.
  + if the student was above, at, or below grade level.
  + if the student was at risk of poor reading outcomes.

The teacher then needed to refer to the figure without the *SEM* to answer the following questions.

* Which line might be better for progress monitoring?

* Based on the trajectory of the lines - that is, the shape of the lines - which line might be more trustworthy?

* Let’s say the figure shows data of a student receiving a reading intervention.

  + For both the the YELLOW and BLACK lines separately: Look at the first three data points only (ignore the last data point from May or June). What might you say about the intervention? Why?
...
* Which line might be better for progress monitoring and data-based decisions? Why?
...
Teachers in Grades 3 and 4 were also
given the students' year-end Smarter Balanced ELA (reading) performance level and were asked the following questions.
...
* Based on the first data point from Oct or Nov ONLY, which point might better match what you expect from a student at this performance level?
